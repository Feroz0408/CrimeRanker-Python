...
assault_tweets = "data/assault_data1.csv"
# theft_tweets = "data/theft_data1.csv"
...
Assault_keywords = '#assault OR #arson OR #childabuse OR #abuse OR #domesticabuse OR #domestic OR #kidnapping'
Theft_keywords = '#burglary OR #larceny OR #robbery OR #autotheft OR #shoplifting OR #theft'
Murder_keywords = '#murdered OR #murder OR #killed OR #shot OR #dead'
Statutory_keywords = '#drugcrime OR #trafficoffense OR #alcohalcrime OR #whitecollarcrime OR #financialcrime OR #fraud OR #blackmail OR #drugtrafficking OR #homicide' 
